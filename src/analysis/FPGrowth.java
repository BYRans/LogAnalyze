...
public class FPGrowth {
	public static int WINDOWN_SIZE = 60;// 窗口大小，分钟为单位
	...
	public static void main(String[] args) throws IOException, Exception {
		...
		printTree(treeroot, "", true,
				"C:/Users/Administrator/Desktop/test/145+alert_tree.txt");// 打印FPTree树
		printTreePaths(treeroot,
				"C:/Users/Administrator/Desktop/test/145+alert_R2L.txt");// 打印FPTree根节点到叶节点路径
